angular.module('treehouseCourse', [])
  ...
  .controller('stageFourCtrl', function ($scope, People) {
    ...
    //              ng-model serves to write values to properties
    //              ng-model = "person.name"  should always have a .  accessing a property nested inside an object

    //  ng-click --

    //  ng-show / ng-hide  --  display or hide an element based on a conditional expression
    //  ng-show = "person.email"  anytime there is no email, the whole tag will be hidden
